...
public class AddressConfig {
	...
	public ConsumerFactory<String, Address> consumerFactory() {
		...
		props.put(ConsumerConfig.GROUP_ID_CONFIG, "top");
		...
		props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, com.example.scheduler.entity.Address.class);
		return new DefaultKafkaConsumerFactory(props, null, new StringDeserializer());
	}

	@Bean
	public KafkaListenerContainerFactory<?> addressKafkaJsonListenerContainerFactory() {
